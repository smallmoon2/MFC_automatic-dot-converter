	...
	CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CMFCApplication9View), CSize(1000, 1000),
		pContext);
	zxclss = ((CMFCApplication9View*)m_wndSplitter.GetPane(0, 0));
	m_wndSplitter.CreateView(0, 1,RUNTIME_CLASS(COtherview), CSize(300, 200),
		pContext);
	asd = ((COtherview*)m_wndSplitter.GetPane(0, 1));
